  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-extrabold px-2 py-0.5 rounded-full bg-blue-100 dark:bg-blue-900/60 text-blue-700 dark:text-blue-300">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {isAdmin && (
            <button
              ...
              className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-extrabold text-xs rounded-xl shadow-md shadow-blue-600/20 flex items-center gap-2 transition-all cursor-pointer"
            >
      ...
      {isAdmin && showCreateModal && (
        ...
        <div className="bg-gradient-to-br from-white via-blue-50/30 to-blue-50/20 dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 border border-blue-200 dark:border-blue-900/40 rounded-2xl p-5 shadow-2xl space-y-4 max-w-3xl w-full my-8">
          ...
          <form onSubmit={handleCreateGoal} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 text-xs font-bold bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-blue-600 dark:text-blue-400"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-4 items-end pt-1">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 text-xs bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-slate-900 dark:text-slate-100 placeholder:text-slate-400"
                />
              </div>
            ...
            {showSuccessMsg && (
              <div className="p-3 bg-blue-100 dark:bg-blue-950/80 border border-blue-300 dark:border-blue-800 text-blue-800 dark:text-blue-200 text-xs font-bold rounded-xl flex items-center gap-2 animate-fade-in">
          ...
          return (
            <div
              ...
              className={`bg-white dark:bg-slate-900 border rounded-2xl p-5 shadow-xs space-y-4 transition-all relative overflow-hidden ${
                isCompleted
                  ? 'border-blue-500 dark:border-blue-600 ring-2 ring-blue-500/20'
                  : isNearCompletion
            ...
            >
              ...
              {isCompleted && (
                <div className="bg-gradient-to-r from-blue-600 to-blue-600 text-white text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-bl-xl shadow-xs flex items-center gap-1 absolute top-0 right-0">
              ...
              <div className="flex items-center justify-between gap-2 pr-20">
                <div className="flex flex-wrap items-center gap-1.5">
                  ...
                  {isQuantityMetric ? (
                    <span className="text-[10px] font-extrabold uppercase px-2 py-0.5 rounded bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-300 flex items-center gap-1">
              ...
              <div className="text-[11px] text-slate-500 dark:text-slate-400 flex items-center justify-between pt-2 border-t border-slate-100 dark:border-slate-800 font-medium">
                ...
                {percent >= 100 ? (
                  <span className="text-blue-600 dark:text-blue-400 font-bold flex items-center gap-1 bg-blue-50 dark:bg-blue-950 px-2 py-0.5 rounded-full">
        ...
        <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 max-w-md w-full shadow-2xl space-y-4">
            ...
            <form onSubmit={handleSaveGoalEdit} className="space-y-4">
              ...
              <div className="p-3 bg-blue-50 dark:bg-blue-950/50 rounded-xl border border-blue-200 dark:border-blue-800 text-[11px] text-blue-800 dark:text-blue-300 flex items-start gap-2">
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 text-xs font-extrabold bg-blue-600 hover:bg-blue-700 text-white rounded-xl shadow-xs flex items-center gap-1.5 cursor-pointer"
                >
        ...
        <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 max-w-3xl w-full shadow-2xl space-y-5">
            <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-2xl bg-blue-100 dark:bg-blue-950 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800">
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <div className="space-y-2">
                    {completedGoals.map((gs) => (
                      <div
                        key={gs.goal.id}
                        className="p-3 bg-blue-50/70 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800/60 rounded-xl flex items-center justify-between"
                      >
                        <div>
                          <div className="font-bold text-xs text-slate-900 dark:text-slate-100">
                            {gs.goal.title}
                        ...
                        <span className="text-xs font-extrabold text-blue-700 dark:text-blue-300 bg-blue-200 dark:bg-blue-900 px-2.5 py-1 rounded-full flex items-center gap-1">
